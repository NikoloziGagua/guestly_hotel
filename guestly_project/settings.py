"""
Django settings for guestly_project project.
...
SECRET_KEY = 'django-insecure-&ea05kywwrt=dh06a4pah(q^2e7=*g*&g=7)02c@$se2^zt6y9'
...
ROOT_URLCONF = 'guestly_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'users.context_processors.developer_mode',
            ],
        },
    },
]

WSGI_APPLICATION = 'guestly_project.wsgi.application'
import os
